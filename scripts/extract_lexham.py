...
Usage:
    python3 extract_lexham.py                          # sample mode → output/Scripture/
    python3 extract_lexham.py --full                   # full OT     → output/Scripture-full/
    python3 extract_lexham.py --full --output-root=DIR
    python3 extract_lexham.py --output-root=DIR
...
def main() -> None:
    ...
    result = bootstrap("lexham", output_dir=output_root, full_run=full_run).extract()
